...
const getCurrentTime = () => chalk.gray(moment().tz("Asia/Manila").format("HH:mm:ss DD/MM/YYYY"));
...
module.exports = {
    ...
    success: function (prefix, message) {
        ...
        console.log(`${getCurrentTime()} ${chalk.cyanBright(`${characters} ${prefix}:`)}`, message);
    },
    master: function (prefix, message) {
        ...
        console.log(`${getCurrentTime()} ${chalk.hex("#eb6734").bold(`${characters} ${prefix}:`)}`, message);
    },
};